...
function install() {
    docker pull homeassistant/amd64-hassio-supervisor:2021.02.11
    docker pull homeassistant/amd64-hassio-cli:2021.02.1
}
...
function run_supervisor() {
    docker run --rm --privileged \
        ...
        homeassistant/amd64-hassio-supervisor:2021.02.11
}
